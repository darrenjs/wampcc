...
## Sources that will need compiling
##
SOURCES_BIN2 = realm_registry.cc utils.cc SessionMan.cc Session.cc IOHandle.cc Topic.cc IOLoop.cc rpc_man.cc event_loop.cc  client_service.cc dealer_service.cc Logger.cc Callbacks.cc  pubsub_man.cc admin.cc

##
## Sources that will need compiling
##
SOURCES_BIN3 = realm_registry.cc utils.cc  SessionMan.cc Session.cc IOHandle.cc Topic.cc IOLoop.cc rpc_man.cc event_loop.cc client_service.cc dealer_service.cc Logger.cc  Callbacks.cc  pubsub_man.cc client.cc
